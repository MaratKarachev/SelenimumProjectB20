...
public class ActionsPractices {
    ...
    public void p2_double_click_test() {
        ...
        //Creating actions instance to be able to use methods what come with it.
    ...
    */
     ...
     */
        ...
        //to be able to right click, we need to create an actions instance
        Actions actions = new Actions(Driver.getDriver());
        BrowserUtils.wait(2);
        //using context click to right click on the box
