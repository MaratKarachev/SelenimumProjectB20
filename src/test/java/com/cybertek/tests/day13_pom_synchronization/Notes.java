        ...
        What Design Pattern we have used?
            -Singleton Design Pattern
                ...
                -How did we achieve Singleton Design Pattern?
                    -Created a private constructor, and created getter method that returns the same driver
                    instance all the time.

            -Page Object Model Design Pattern, aka(also know as) POM
                -What is Page Object Model Design Pattern:
                    -Creating java classes for the each page of AUT. And we store related web
                    elements in its own java class.
                        -LoginPage.java
                            -username
                            -password
                            -loginButton
             ...
             What are the advantages of using POM?
                ...
                -Easy to maintain: Since we store each web element ONLY once, we know exactly where
                to find the web element and how to fix the problem.
                -Readable: Very easy to understand

             How do we achieve Page Object Model Design Patter?
