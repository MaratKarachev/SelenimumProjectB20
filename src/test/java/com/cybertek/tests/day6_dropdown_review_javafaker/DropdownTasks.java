...
public class DropdownTasks {
    ...
    public void test2_verify_state_dropdown() throws InterruptedException {
        ...
        //4. Select Virginia => by selecting value
        Thread.sleep(1000);
    ...
    public void test3_date_dropdown_verification() {
        ...
        //Selecting day 1 by using index
        dayDropdown.selectByIndex(0);

        //creating expected values on one place
        ...
        Assert.assertEquals(actualYear, expectedYear, "Actual year vse expected year not equal");
    ...
    public void test4_multiple_value_select_dropdown() throws InterruptedException {
        ...
        for (WebElement eachOption : allOptions) {
            ...
            //Asserting each option is selected
