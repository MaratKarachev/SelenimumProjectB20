...
LOCATORS:
    ...
    3-linkText
        ...
        <a href="">text</a> looking for a text between opening and closing tags.
    ...
    6-tagName
        - it looks for tagName and returns the matching webElement(s).
...
.getAttribute("attribute");
  ...
  <div class="uh7" id="ba83" name ="uk99"> OPENING TAG
        <a href="https://www.tesla.com"> Tesla WebPage</a>
    </div>
    ex:
...
#7 -> cssSelector:
    ...
    - using cssSelector you will be able to locate pretty much everything web element on the page
    ...
    div[class = 'uh7'] --> this will locate the web element above using cssSelector with class attribute.
    div[id = 'ba83'] --> this will use id value to locate same web element
    div[name = 'uk99'] --> this will use attr name value to locate same web element
    ...
    You need to open the developer tool first -> right click -> inspect
    command +F
...
#8 - xpath
    ...
    When do we use xpath and cssSelector? practice more and more to locate web elements.
    ...
    #2 - RELATIVE XPATH:
        ...
        -This is a lot more reliable than absolute xpath
        -This is a lot more specific than absolute xpath

        Syntax: //tagName --> simple syntax that will find and return the first matching tagName
